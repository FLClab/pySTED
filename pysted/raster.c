...
static PyObject *__pyx_kp_s_wow;
 ...
 *     if seed == 0:
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_wow) < 0) __PYX_ERR(0, 175, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_wow, __pyx_k_wow, sizeof(__pyx_k_wow), 0, 0, 1, 0},
