...
data_resolution = eval(sys.argv[2]) # nm
...
signal_rescale = utils.rescale(signal, int(pixelsize / data_resolution))
...
pyplot.figure()
pyplot.title("Signal rescaled")
pyplot.imshow(signal_rescale, interpolation="nearest")
pyplot.colorbar()
#pyplot.savefig(results_path + "signal_rescaled.png", borderpad=.1)
